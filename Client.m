...
-(void)getWeatherInfoWithCity:(NSString *)cityName{
    ...
    //param
    NSString *param =[NSString stringWithFormat:@"%@&mode=json&units=metric&cnt=7&appID=8b7661be7bbdbfb1004eb364dd045ab6", cityName];//&appID=8b7661be7bbdbfb1004eb364dd045ab6
